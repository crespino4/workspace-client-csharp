...
namespace Genesys.Workspace.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoicecallsidreconnectData :  IEquatable<VoicecallsidreconnectData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicecallsidreconnectData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VoicecallsidreconnectData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicecallsidreconnectData" /> class.
        /// </summary>
        ...
        public VoicecallsidreconnectData(string HeldConnId = default(string), List<Kvpair> Reasons = default(List<Kvpair>), List<Kvpair> Extensions = default(List<Kvpair>))
        {
            ...
            if (HeldConnId == null)
            {
                throw new InvalidDataException("HeldConnId is a required property for VoicecallsidreconnectData and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VoicecallsidreconnectData);
        }

        /// <summary>
        /// Returns true if VoicecallsidreconnectData instances are equal
        /// </summary>
        /// <param name="other">Instance of VoicecallsidreconnectData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicecallsidreconnectData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

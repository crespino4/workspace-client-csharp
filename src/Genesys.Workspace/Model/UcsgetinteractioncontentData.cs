...
namespace Genesys.Workspace.Model
{
    ...
    public partial class UcsgetinteractioncontentData :  IEquatable<UcsgetinteractioncontentData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UcsgetinteractioncontentData);
        }

        /// <summary>
        /// Returns true if UcsgetinteractioncontentData instances are equal
        /// </summary>
        /// <param name="other">Instance of UcsgetinteractioncontentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UcsgetinteractioncontentData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Genesys.Workspace.Model
{
    ...
    public partial class InteractionContentData :  IEquatable<InteractionContentData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InteractionContentData);
        }

        /// <summary>
        /// Returns true if InteractionContentData instances are equal
        /// </summary>
        /// <param name="other">Instance of InteractionContentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InteractionContentData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

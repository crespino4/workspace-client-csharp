...
namespace Genesys.Workspace.Model
{
    ...
    public partial class ReportingunsubscribeData :  IEquatable<ReportingunsubscribeData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReportingunsubscribeData);
        }

        /// <summary>
        /// Returns true if ReportingunsubscribeData instances are equal
        /// </summary>
        /// <param name="other">Instance of ReportingunsubscribeData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportingunsubscribeData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

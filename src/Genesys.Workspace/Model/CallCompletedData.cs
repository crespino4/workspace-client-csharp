...
namespace Genesys.Workspace.Model
{
    ...
    public partial class CallCompletedData :  IEquatable<CallCompletedData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallCompletedData);
        }

        /// <summary>
        /// Returns true if CallCompletedData instances are equal
        /// </summary>
        /// <param name="other">Instance of CallCompletedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallCompletedData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

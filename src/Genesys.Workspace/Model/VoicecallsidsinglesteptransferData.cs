...
namespace Genesys.Workspace.Model
{
    ...
    public partial class VoicecallsidsinglesteptransferData :  IEquatable<VoicecallsidsinglesteptransferData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VoicecallsidsinglesteptransferData);
        }

        /// <summary>
        /// Returns true if VoicecallsidsinglesteptransferData instances are equal
        /// </summary>
        /// <param name="other">Instance of VoicecallsidsinglesteptransferData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicecallsidsinglesteptransferData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

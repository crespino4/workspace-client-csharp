...
namespace Genesys.Workspace.Model
{
    ...
    public partial class DeleteContactData :  IEquatable<DeleteContactData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeleteContactData);
        }

        /// <summary>
        /// Returns true if DeleteContactData instances are equal
        /// </summary>
        /// <param name="other">Instance of DeleteContactData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteContactData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
